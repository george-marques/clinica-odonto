...
public abstract class ReportServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -1668897511462430044L;
	...
	/**
	 * 
	 * @return retorna os tipos dos parametros, ex. HashMap<String, Class<?>> param
	 *         = new HashMap<String, Class<?>>(); param.put("ID_MARCA",
	 *         Integer.class); return param;
	 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			GerarRelatorio gerador = new GerarRelatorio(nome, parametros, connection);
